    ...
    {!! Form::open([
        ...
        <div class="col-xl-3 push-xl-3 col-lg-3 push-lg-3 col-md-3 col-sm-3 col-xs-3">
            {!! Form::text('name', null, [
                ...
                'placeholder' => trans('survey.name_survey')
            ]) !!}
        </div>
        <div class="col-xl-3 push-xl-3 col-lg-3 push-lg-3 col-md-3 col-sm-3 col-xs-3">
            {!! Form::select('status', [
            ...
            ], null, ['class' => 'select-list-survey element-search-survey', 'placeholder' => trans('survey.status')]) !!}
        </div>
        <div class="col-xl-3 push-xl-3 col-lg-3 push-lg-3 col-md-3 col-sm-3 col-xs-3">
            {!! Form::select('privacy', [
            ...
            ], null, ['class' => 'select-list-survey element-search-survey', 'placeholder' => trans('survey.privacy')]) !!}
        </div>
