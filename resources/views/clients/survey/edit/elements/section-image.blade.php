<li class="form-line sort section-show-image-insert"
    ...
    data-question-type="{{ config('settings.question_type.image') }}">
        ...
        <div class="col-xs-12 col-md-12 col-sm-12">
            <div class="box-show-image">
                {!! Form::hidden("media[section_$sectionId][question_$question->id]",
                    ...
                    ['class' => 'input-image-section-hidden']) !!}
                @if ($question->media->count())
                    <img class="img-fluid show-image-insert-section" src="{{ $question->media->first()->url }}" alt="">
                @endif
