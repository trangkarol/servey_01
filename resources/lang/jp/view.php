...
return [
    'footer' => [
        'about' => [
            'title' => '会社概要',
            'content' => 'ベトナムのFramgiaは日本では100％を投資されています. 電話アプリケーション、
    ゲーム、ソーシャルアプリケーションやWebベースのアプリケーションを構築に特化.',
        ],
        'contact' => [
            'title' => '連絡先',
            'content' => 'あなたは情報を通して私たちに連絡することができます',
            'home' => '13フロアのKeangnam, E6の小包, Pham Hung 砂糖,Tu Liem Nam, Ha Noi, Viet Nam',
            'email' => 'hr_team@framgia.com',
            'phone' => '84-4-3795-5417',
            'telephone' => '電話',
            'more_info' => 'さらに詳しい情報',
            'intro' => 'Fsurvey -  シンプルで便利で強力なアンケートシステム。',
        ],
        'back_to_top' => 'トップに戻る',
        'copyright' => 'コピーライト 2016 Framgia, Inc.',
        'reserved' => 'すべての権利を保有',
    ],
    'body' => [
        'intro' => [
            'slogan' => 'サービスと顧客満足度を向上させる',
            'fully_responsive' => '完全に反応する',
