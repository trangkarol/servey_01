...
return [
    ...
    'body' => [
        'intro' => [
            ...
            'content_thank_your_time' => 'Fsurvey - dễ dàng sử dụng và đo lường kết quả nhanh chóng',
            'content_thank_your_time2' => 'Đáp ứng đầy đủ; số liệu điề tra hữu dụng, nhận survey qua email',
            'some_devices' => 'CÁC THIẾT BỊ PHÙ HỢP',
            'content_some_devices' => 'Bạn có thể thực hiện khảo sát với FSurvey bằng nhiều thiết bị như',
        ],
    ],
    '404' => '404',
    'error' => 'Lỗi',
